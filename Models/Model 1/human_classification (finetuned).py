...
vgg_dnn.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.0001),
                loss="categorical_crossentropy",
                metrics=["accuracy"])

history = vgg_dnn.fit(train_data, validation_data=val_data, epochs=20)
...
#     aa.TimeStretch(min_rate=0.8, max_rate=1.2, p=0.3),
