...
# Paths
birds_mp3_path = "/content/Voice of Birds/Voice of Birds"  # Path to the Birds dataset (MP3 files)
...
# Save audio features (X)
np.save('/content/drive/MyDrive/preprocessed_audio_X.npy', X)

# Save labels (y)
np.save('/content/drive/MyDrive/preprocessed_labels_y.npy', y)

X_loaded = np.load('/content/drive/MyDrive/preprocessed_audio_X.npy')
y_loaded = np.load('/content/drive/MyDrive/preprocessed_labels_y.npy')
